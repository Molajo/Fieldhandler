...
class LocalReadTest extends Data
{
    ...
    /**
     * @covers Molajo\Filters\Type\Local::read
     */
    public function testReadSuccessful()
    {
        $adapter = new filterAdapter($this->action, $this->path);
    ...
    /**
     * @covers Molajo\Filters\Type\Local::read
     * @expectedException Molajo\Filters\Exception\NotFoundException
     */
    public function testReadUnsuccessful()
    {
        $this->path = BASE_FOLDER . '/Tests/Data/testreally-is-not-there.txt';
        $adapter    = new filterAdapter($this->action, $this->path, $this->filesystem_type, $this->options = array());
